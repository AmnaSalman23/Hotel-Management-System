...
"")
        ...
        self.showPasswordBtn = QtWidgets.QCheckBox(self.frame_12)
        font = QtGui.QFont()
        font.setFamily("Roboto")
        ...
        self.gridLayout_6.addWidget(self.showPasswordBtn, 0, 0, 1, 1)
...
"border-bottom:2px solid black;")
        ...
        self.signUpRole = QtWidgets.QComboBox(self.frame_2)
        self.signUpRole.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.signUpRole.setFont(font)
        self.signUpRole.setStyleSheet("border:none;\n"
"border-bottom:2px solid black;")
        self.signUpRole.setObjectName("signUpRole")
        self.signUpRole.addItem("")
        self.signUpRole.addItem("")
        self.signUpRole.addItem("")
        self.gridLayout_2.addWidget(self.signUpRole, 12, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.signUpRole.setItemText(0, _translate("MainWindow", "Guest"))
        self.signUpRole.setItemText(1, _translate("MainWindow", "Manager"))
        self.signUpRole.setItemText(2, _translate("MainWindow", "Front Desk"))
import resource_rc
